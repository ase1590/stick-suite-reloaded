...
void wifi_spam_main(void) {
	...
	// revised based on https://esp32.com/viewtopic.php?f=13&t=1317&p=5942&hilit=c+initializer#p5942
	wifi_config_t wifi_config = { };
    strcpy((char*)wifi_config.ap.ssid, "esp32-spam");
    strcpy((char*)wifi_config.ap.password, "maness123");
...
//
	...
	xTaskCreate(&spam_task, "spam_task", 2048, NULL, 5, &TaskHandle_1);
}
...
void setup_wifispam()
{
	if(setup_wifispam_complete == false)
	{
        ...
        Serial.begin(115200);
        Serial.println();
		setup_wifispam_complete = !setup_wifispam_complete;
		delay(1000);
		M5.Lcd.println("Spamming wifi");
		wifi_spam_main();
